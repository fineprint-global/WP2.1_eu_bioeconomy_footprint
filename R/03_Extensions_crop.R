...
#' 
#' @description This function loads the input data generated with IIASA's LANDFLOW model and generates extensions to the 
#' MRIO model using the previously derived allocation shares.
#' 
...
prepare_mrio_extensions <- function(years = 1995:2010, nrreg = 21, nrsec = 200, nrinput = 17, ...){
